...
const routes = (app) => {
    ...
    app.get('/e/:blnqName?', async (req, res) => {
        ...
        var blnqImage = req.params.blnqName
            ...
            : 'https://studio.blnq.io/manifest/icon-mobile@512w.png';
    ...
    app.use('/sitemap.xml', express.static('manifest/sitemap.xml'));
    ...
    app.use(
        '/supersecrethiddenpagethatnoonewillfind',
        express.static('dist/secret.html')
    ); //Show Dashboard
    app.use('/ofstart', express.static('dist/ofstart.html')); //Show OpenFinStart, should only really be touchable from OpenFin.....
    //Show Dashboard
    app.use('/mydashboard', express.static('dist/mydashboard.html')); //Show Dashboard
