...
function generateIndexHTML(blnqName) {
    return 'FIX THIS';
}
...
<html lang="en">
    <head>
        ...
        <meta
            ...
            content="A Collaborative Web Development Platform using HTML, CSS and JavaScript with a focus on Design Systems and Financial Applications using OpenFin and Electron"
        />
	...
	<body>
		${html}
		<script src="/f/${blnqName}.js"></script>
	</body>
</html>`);
        }
    });
...
<html lang="en">
    ...
    app.get('/lh/:blnqName', async function (req, res) {
        ...
        (async () => {
            try {
                ...
                // console.log('Should we push to the database here too?');
                // console.log(scores);
    ...
    app.get('/openfin', async function (req, res) {
        var manifestFile = fs.readFileSync(
            './assets/manifest/openfin.json',
            'utf-8'
        );
        ...
        var manifest = manifestFile.replace(/{url}/gi, url);
